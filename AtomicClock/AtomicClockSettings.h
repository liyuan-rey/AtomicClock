...
static const DWORD ATOMICCLOCK_SETTING_VERSION = 1;

class CAtomicClockInfo : public CSettings
{
public:
	...
	BEGIN_SETTING_MAP(CAtomicClockInfo)
		SETTING_ITEM_DEFAULT(Version, ATOMICCLOCK_SETTING_VERSION)
...
class CMainSettings : public CSettings
{
public:
	static const TCHAR defaultSectionName[];

	CAtomicClockInfo Info;
	CAtomicClockSettings AtomicClock;
	CTrayClockSettings TrayClock;

	BEGIN_SETTING_MAP(CMainSettings)
